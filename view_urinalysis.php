	...
	<div class = "well">
		...
		<div class = "panel panel-success">	
			...
			<?php
				...
				$f = $q->fetch_array();
				$q1 = $conn->query("SELECT COUNT(*) as total FROM `complaints` where `status` = 'Pending' && `itr_no` = '$f[itr_no]' && `section` = 'Urinalysis'") or die(mysqli_error());
				$f1 = $q1->fetch_array();
			?>
				...
				<a style = "float:right; margin-top:-4px; margin-right:5px;" href = "urinalysis_pending.php?itr_no=<?php echo $f['itr_no']?>" class = "btn btn-info">REQUEST <span class = "badge"> <?php echo $f1['total']?></span></a>
