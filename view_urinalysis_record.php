		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			?>
				<tr>
					...
					<td><center>
							<a href = "urinalysis_record.php?itr_no=<?php echo $f['itr_no']?>&urinalysis_id=<?php echo $f['urinalysis_id']?>"class = "btn btn-info"><span class = "glyphicon glyphicon-book"></span> All Records</a> 
						</center></td>
				</tr>
			<?php
				}
