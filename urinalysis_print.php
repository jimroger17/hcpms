	...
	<div id="print">
		<div style = "margin:10px;">	
			...
			<div style = "float:left; margin-left:50px;">	
				<label><center>Barangay Lecheria Sitio Ronggot</center></label>
				<label style = "font-size:14px;"><center>Barangay Lecheria Sitio Ronggot Health Center - Calamba City</center></label>
