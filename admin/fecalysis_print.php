...
<br />
	<div id="print">
		<div style = "margin:10px;">
			<center><label>Barangay Lecheroa Sitio Ronggot Health Center</label></center>
			<center><label style = "font-size:12px;">Barangay Lecheria Sitio Ronggot, Calamba City</label></center>
			<br />
			<br />
