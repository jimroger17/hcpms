	...
	<div id="print">
		<div style = "margin:10px;">
			...
			<div style = "margin-right:190px;">
				...
				<label><center>Probinsya ng Laguna</center></label>
				<label><center>Lungsod ng Calamba</center></label>
				<label><center>Barangay Lecheria Sitio Ronggot Health Center</center></label>
			</div>
			<br />
