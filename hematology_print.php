...
<br />
	<div id="print">
		<div style = "margin:10px;">	
			<label style = "font-size:18px;"><center>Barangay Lecheria Sitio Ronggot</center></label>
			<label><center>Barangay Lecheria Sitio Ronggot Health Center - Calamba City</center></label>
