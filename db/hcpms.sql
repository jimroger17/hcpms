...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2024 at 02:52 PM
...
(6, '2024-11-10', 'Dr. Adelino Labro', 1, '1', 18, 'Nov', '2024');
...
--
ALTER TABLE `hematology`
  MODIFY `hem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `prenatal`
  MODIFY `prenatal_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `radiological`
--
ALTER TABLE `radiological`
  MODIFY `rad_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
