...
<br />
	<div id="print" style = "max-width:850px;">
		<div style = "margin:10px;">	
			...
			<center><label>Province of Laguna</label></center>
			<center><label>CITY OF CALAMBA</label></center>
			<center><label>Barangay Lecheria Sitio Ronggot Health Center</label></center>
			<center><label>Tel. No. 0917-959-3695</label></center>
			<br />
